            ...
            <div className="container">
                <div className="row justify-content-between mil-mb-120">
                    ...
                    <div className="col-xl-6">
                        ...
                        <p className="mil-appearance mil-mt-55-adapt mil-mb-30" style={{color:"#001413"}}>{Data.description}</p>
                    ...
                    {Data.items.map((item, key) => (
                        <div className="col-lg-4" key={`pricing-item-${key}`}>
                            ...
                            <div className="mil-price-card mil-appearance mil-mb-30">
                                ...
                                <div className="mil-price-number mil-mb-10">{item.price}<span style={{color:"#001413"}}>{item.price_after}</span></div>
                                ...
                                <ul className="mil-mb-30">
                                    {item.list.map((element, key2) => (
                                        <li className={element.active != 1 ? "mil-empty" : ""} key={`pricing-item-${key}-list-${key2}`}>
                                            {element.active == 1 &&
                                                <svg style={{ height: "24px", width: "24px", flexShrink: "0" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                            ...
                                            <span style={{color:"#001413"}}>{element.value}</span>
                                        </li>
                                    ))}
                                </ul>
