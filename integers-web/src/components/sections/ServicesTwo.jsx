                ...
                <div className="container">
                    <div className="row justify-content-between align-items-center">
                        <div className="col-xl-5 mil-mb-120">
                            ...
                            <p className="mil-appearance mil-mb-30" style={{ color: "#001413" }}>{Data.description}</p>

                            {/* buttons */}
                            <div className="mil-appearance">
                                <Link href={Data.button1.link} style={{ backgroundColor: "#0984E3", color: "#FFF" }} className="mil-button mil-button-lg mil-scale-down-trigger mil-buttons-space"><span>{Data.button1.label}</span></Link>
