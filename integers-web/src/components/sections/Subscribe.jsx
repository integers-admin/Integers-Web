        ...
        <div className="container mil-p-0-90">
            <form action={appData.settings.mailchimp.url} method="post" target="_blank">
                <div className="row align-items-center justify-content-between">
                    ...
                    <div className="col-lg-2">
                        {/* button */}
                        <div className="mil-appearance"><button type="submit" className="mil-button mil-button-md mil-scale-down-trigger mil-mb-30" style={{backgroundColor:"#0984E3",color:"#FFF"}}>Subscribe Now</button></div>
                    </div>
                </div>
