      ...
      <div className="container mil-mb-120">
          ...
          <div className="row justify-content-center">
              <div className="col-lg-12 col-xl-9 mil-content-frame mil-appearance mil-p-120-0">
                  ...
                  <h3 className="mil-link mil-text-center mil-appearance mil-softened-60 mil-mb-30" style={{ width: '100%' }}>
                    <span style={{color:"#001413"}}>{postData.category}</span>
                    </h3>
                  ...
                  <ul className="mil-project-info mil-appearance mil-mb-30">
                      ...
                      <li key={`project-list-${key}`}>
                        ...
                        <span className="mil-link mil-softened-60">
                          <span style={{color:"#001413"}}>{item.value}</span></span>
                      </li>
                      ))}
                  </ul>
                  {/* project info end */}
              ...
              {typeof postData.description0 != "undefined" &&
                <>
                  ...
                  <div className="col-lg-10 col-xl-6">
                      <p className="mil-first-letter mil-appearance" style={{color:"#001413"}}>
          ...
          {typeof postData.finalImage != "undefined" &&
            <>
              ...
              <div className="row justify-content-center mil-p-0-90" style={{marginTop:"50px"}}>
                  <div className="col-lg-12 col-xl-9">
                      <Item
