                ...
                <div className="mil-footer-content mil-p-120-90">
                    <div className="row justify-content-between">
                        <div className="col-lg-6 col-xl-4 mil-mb-30">
                            ...
                            <p className="mil-mb-30" style={{ color: "#FFF" }}>{appData.footer.description}</p>
                        </div>
                        <div className="col-lg-12 col-xl-8">
                            <div className="row justify-content-xl-end">
                                    ...
                                    <ul>
                                        {appData.footer.links.map((item, key) => (
                                            <li key={`footer-links-item-${key}`}>
                                                <Link href={item.link} className="mil-link mil-link-hover mil-softened-50 mil-light mil-mb-15">{item.label}</Link>
                                            </li>
                                        ))}
                                    </ul>
                                ...
                                <div className="col-lg-4 col-xl-4 mil-mb-30">
                                    ...
                                    {/* email */}
                                    <a href={`mailto:${appData.contacts.email}`} className="mil-link mil-link-hover mil-accent mil-hidden-trigger mil-mb-30">
                                        {appData.contacts.email}
                                        </a>
                                    {/* phone */}
                                    <p className="mil-light mil-text-xl mil-bold mil-mb-30"><a href={`tel:${appData.contacts.tel}`}>{appData.contacts.tel}</a></p>
                                    ...
                                    <ul className="mil-social mil-hidden-trigger mil-left">
                                        ...
                                        {appData.social.map((item, key) => (
                                            <li key={key}>
                                                <a href={item.link} title={item.title} target="_blank" rel="noopener noreferrer" className="mil-light"
                                                    // onMouseEnter={(e) => e.currentTarget.querySelector("i").style.color = "#6CD3D0"}
                                                    // onMouseLeave={(e) => e.currentTarget.querySelector("i").style.color = ""}
                                                >
                                                    {/* <i className={item.icon} /> */}
                    ...
                    <div className="mil-footer-instagram mil-mb-120">
                        ...
                        <div className="mil-instagram-frame">
                            ...
                            <div className="mil-button-positions mil-appearance">
                                <a href={appData.footer.instagram.button.link} target="_blank" className="mil-button mil-button-lg mil-button-rounded mil-button-accent mil-scale-down-trigger" style={{ backgroundColor: "#0984E3", color: "#FFF" }}><span><i className="fab fa-instagram"></i> {appData.footer.instagram.button.label}</span></a>
                            </div>
                        </div>
                        {/* instagram end */}
                    </div>
