...
const About2 = (props) => {
  ...
  return (
    <>
      <Seo
        title="About Integers Insights | Who We Are & What We Do"
        description="integers Insights is an AI-driven SaaS company transforming market research through trend & competitor analysis- helping businesses grow smarter globally"
        url="https://www.integersinsights.com/about"
      />
