...
const About2 = (props) => {
    ...
    const Content = {
        "about1": {
            ...
            "title": "The Minds Behind Intelligent Growth",
            "text_1": "Integers Insights is crafted by a talented team of AI engineers, data scientists, growth strategists, and SaaS architects who are all about creating scalable business systems. We blend artificial intelligence, cutting-edge analytics, automation, and digital marketing know-how to empower U.S. businesses to work smarter and expand more rapidly.",
            "text_2": "Our crew develops measurable, ROI-focused solutions that turn raw data into clear decisions, predictable revenue, and a lasting competitive edge through structured execution and smart technology.",
        ...
        "about2": {
            ...
            "title": "Writing content like you’ve never had before",
            "text_1": "We create and implement web applications powered by AI, along with enterprise SaaS platforms and smart automation systems that drive business growth. Our offerings include tailored AI agents, workflow automation, robust enterprise data infrastructure, predictive analytics dashboards, and sophisticated business intelligence solutions specifically designed for U.S. companies. Additionally, we deliver market research reports, competitive insights, and data-driven analyses that empower leadership teams to make well-informed strategic choices.",
            "text_2": " On the growth front, we roll out AI-driven marketing automation, B2B lead generation systems, sales automation pipelines, CRM enhancements, and performance-focused digital marketing campaigns aimed at boosting conversions and lowering acquisition costs. By blending technology, analytics, and digital strategy, we assist organizations in streamlining their operations, enhancing decision-making, and scaling revenue with clear, measurable, data-driven outcomes."
        },
        "gallery": [
            {
                "url": "/img/content/Ourstory1.jpg",
                "width": 1000,
                "height": 1500
            },
            {
                "url": "/img/content/Ourstory5.jpg",
                "width": 1920,
                "height": 1280
            },
            {
                "url": "/img/content/Ourstory3.jpg",
                "width": 1000,
                "height": 1500
            },
            {
                "url": "/img/content/Ourstory2.jpg",
                "width": 1920,
                "height": 1440
            }
        ]
    ...
    return (
        <Layouts>
            <PageBanner pageImage={"/img/content/About us - 1.jpg"} pageTitle={"About 2"} />
                ...
                <div className="row justify-content-between align-items-center">
                    <div className="mil-12 col-xl-5 mil-mb-120">
                        ...
                        <div className="mil-link mil-softened-60 mil-appearance mil-mb-30">
                            <span style={{color:"#001413"}}>{Content.about1.subtitle}</span>
                            </div>
                        <h3 className="mil-appearance mil-mb-30">{Content.about1.title}</h3>
                        <p className="mil-appearance mil-mb-30" style={{color:"#001413"}}>{Content.about1.text_1}</p>
                        <p className="mil-appearance mil-mb-30" style={{color:"#001413"}}>{Content.about1.text_2}</p>
                                ...
                                <div className="mil-circle-text mil-rotate mil-accent-inside mil-appearance" data-value="360">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 300 300" enableBackground="new 0 0 300 300" xmlSpace="preserve">
                                        ...
                                        <g>
                                            ...
                                            <text className="mil-link mil-dark" style={{ "letterSpacing": "3.2px" }}>
                                                {/* circle text */}
                ...
                <div className="row justify-content-between">
                    <div className="col-lg-5">
                        <span className="mil-link mil-softened-60 mil-appearance mil-mb-30">
                            <span style={{color:"#001413"}}>{Content.about2.subtitle}</span>
                            </span>
                    ...
                    <div className="col-lg-6">
                        <div className="row">
                            <div className="col-lg-6">
                                <p className="mil-first-letter mil-appearance mil-mb-30" style={{color:"#001413"}}>{Content.about2.text_1}</p>
                            </div>
                            <div className="col-lg-6">
                                <p className="mil-appearance mil-mb-30" style={{color:"#001413"}}>{Content.about2.text_2}</p>
                            </div>
                        </div>
                    </div>
                </div>
