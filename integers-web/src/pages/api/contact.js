...
<div style="font-family: Outfit, sans-serif; color: #333; line-height: 1.6; max-width: 600px; margin: auto; border-radius: 10px; background-color: #f9f9f9; overflow: hidden;">
    <div style="background-color: #00CEC9; padding: 20px; text-align: center;">
        <h1 style="color: #fff; margin: 0; font-size: 24px;">New Inquiry Received</h1>
    </div>
    <div style="padding: 20px;">
        <p style="color: #00CEC9;font-weight:500; font-size: 20px;">Dear Integers Team,<br> you have received a new inquiry from ${name}</p>
        ...
        <p style="text-align: center; margin-top: 20px;">
            <a href="mailto:${email}" style="display: inline-block; padding: 10px 20px; background-color: #00CEC9; color: #fff; text-decoration: none; border-radius: 5px; font-weight: bold;">
                Reply to ${name}
            </a>
        </p>
    </div>
    <div style="background-color: #f1f1f1; padding: 15px; text-align: center; font-size: 12px; color: #666;">
        This message was submitted through the Integers website contact form.
    </div>
</div>
`,
        };
