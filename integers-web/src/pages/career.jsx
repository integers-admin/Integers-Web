...
const Career = () => {
  ...
  return (
    <>
      <Seo
        title="Careers"
        description="Explore career openings in AI, social media , AI developers, tech engineers & - where innovation, ownership & growth define your everyday work."
        url="https://www.integersinsights.com/career"
      />
      <Layouts>
        <PageBanner
          pageImage={"img/portfolio/Rectangle 39.png"}
          pageTitle={"Portfolio"}
        />
        ...
        <div className="container mil-content-frame mil-p-120-90 mil-appearance">
          ...
          <div className="career-page-main">
            <div className="career-page-child1">
              ...
              <p className="career-page-child1-text3">
                We create an environment that’s all about growth, where
                innovation, ownership, and a love for learning really shine.
                Whether it’s tackling real-world AI projects, facing
                performance-driven challenges, or enjoying a flexible work
                culture that supports career advancement, we empower our team to
                craft meaningful solutions and develop their professional
                skills.
              </p>
            </div>
              ...
              {cardData?.map((item, i) => {
                return (
                  <div className="career-page-child-container" key={i}>
                    <div className="career-page-child-container1">
                      <img src={item.image} alt="icon" />
                    </div>
                    <div className="career-page-child-container2">
                      <p className="career-page-child-container2-txt1">
                        {item.title}
                      </p>
                      <p className="career-page-child-container2-txt2">
                        {item.text}
                      </p>
                    </div>
                  </div>
                ...
                return (
                  <Link key={itm.id} href={`/career/${itm.id}`}>
                    <div className="career-page-main1-child1" key={itm.id}>
                      <p className="career-page-main1-child1-txt">
                        {itm?.title}
                      </p>
                      <p>
