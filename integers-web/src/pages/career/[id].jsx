...
const CareerDetails = () => {
  ...
  const job = careerData.jobs.find((item) => item.id === query.id);
  ...
  return (
    <>
      <Seo
        title={`${job.title} Job Opening | Integers Insights`}
        description={`${job.title} position in ${job.location}. Experience required: ${job.experience}. Apply now at Integers Insights.`}
        url={`https://www.integersinsights.com/careers/${job.id}`}
      />
      <Layouts>
        <div className="main-career-detail">
          <div className="m1">
                ...
                <div className="main-career-container1">
                  ...
                  <div className="career-job-info">
                    ...
                    <div className="career-meta">
                      ...
                      <p>
                        <span>Industry:</span> {job.industry}
                      </p>
                      <p>
                        <span>Employment Type:</span> {job.employmentType}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="career-section">
                    ...
                    <p className="career-paragraph">{job.roleOverview}</p>
                  </div>
                  ...
                  <div className="main-career-container-2">
                    <div className="mil-appearance">
                      <div className="mil-appearance-child">
                        <Link
                          href="https://forms.gle/EcP4J6XEHp7JAx7v5"
                          target="_blank"
                    ...
                    <div className="social">
                      ...
                      <div className="icons">
                        ...
                        <a
                          href="https://www.linkedin.com/company/integerstech/"
                          target="_blank"
                        >
