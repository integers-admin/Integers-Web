...
const Contact = () => {
    ...
    return (
        <Layouts>
            <PageBanner pageImage={"img/content/ContactBanner - 5.jpg"} pageTitle={"Contact"} />
            <ToastContainer />
            {/* contact */}
                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    ...
                                    <div className="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                        <input
                                            ...
                                            value={values.name}
                                        />
                                        <label className="mil-link" style={{ color: "#001413" }}>Name</label>
                                        <span></span>
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <div className="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                        <input
                                            ...
                                            value={values.email}
                                        />
                                        <label className="mil-link" style={{ color: "#001413" }}>Email*</label>
                                        <span></span>
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <div className="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                        ...
                                        />
                                        <label className="mil-link" style={{ color: "#001413" }}>Message</label>
                                        <span></span>
                                        <em>{errors.message && touched.message && errors.message}</em>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <p className="mil-text-sm mil-mb-30" style={{ color: "#001413" }}>Integers Insights Private Limited
                                        Unit No 27, 2nd Floor, Vicino Building,
                                        New Link Road, Goregaon (Mumbai),
                                        Goregaon West, Maharashtra, 400104, India</p>
                                </div>
                                <div className="col-lg-6">
            ...
            <div className="mil-map-frame">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3768.9998950714335!2d72.83179977551264!3d19.151481882068722!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b64733ec72fb%3A0xefe35c447f4acae9!2sVICINO%20by%20ID%20Group!5e0!3m2!1sen!2sin!4v1765869685951!5m2!1sen!2sin"
                    width={600}
                    height={450}
                    style={{ border: 0 }}
                    allowFullScreen
