...
//                       <span style={{color:"#001413"}}>Services</span>
//                       </span>
//                     <h3 className="mil-appearance mil-mb-30">{postData.title}</h3>

//                     <p className="mil-appearance mil-mb-30" style={{color:"#001413"}}>{postData.description}</p>
...
//                         <div className="mil-accordion-group mil-appearance" key={item.label}>
...
import { getAllServicesIds, getServiceData } from "@/src/lib/products";
    ...
    <Layouts>
      ...
      <div className="container mil-content-frame mil-appearance mil-p-120-120">
        ...
        <div className="row justify-content-between">
          <div className="col-lg-4 mil-mb-120">
            <span className="mil-link mil-softened-60 mil-appearance mil-mb-30">
              <span style={{ color: "#001413" }}>Products</span>
            </span>
            <h3 className="mil-appearance mil-mb-30">{postData.title}</h3>
          ...
          <div className="col-lg-6">
            <div className="mil-accordion">
              ...
              {postData.list.map((item, index) => (
                <div
                  className={`mil-accordion-group mil-appearance ${activeIndex === index ? "mil-active" : ""
                    }`}
                  key={item.label}
                >
                  <div
