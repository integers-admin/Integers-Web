...
const Team = () => {
  ...
  return (
    <>
      <Seo
        title="The Team Behind Your AI-Powered Growth"
        description="From AI/ML engineers to brand & design experts - meet our team at Integers Insights building AI tools that transform market research globally."
        url="https://www.integersinsights.com/team"
      />

      <Layouts>
        <PageBanner
          pageImage={"img/content/TeamBanner - 3.jpg"}
          pageTitle={"Team"}
        />
                  ...
                  <div className="mil-cover mil-long">
                    <div className="mil-image-frame">
                      ...
                      <img
                        src={item.image}
                        alt={item.name}
                        style={{ objectPosition: "top", scale: "100%" }}
                      />
                    </div>
                  </div>
                  <div className="mil-overlay mil-with-bg mil-text-center">
                    <div className="mil-description">
                      ...
                      <span className="mil-link mil-softened-50">
                        <span
                          style={{ color: "#001413", letterSpacing: "1px" }}
                        >
                          {item.role}
                        </span>
                      </span>
